...
│   │   │   ├── home.component.css
│   │   │   ├── home.component.html
│   │   │   ├── home-client.component.spec.ts
│   │   │   └── home-client.component.ts
│   │   ├── icons
│   │   │   ├── icons.component.css
│   │   │   ├── icons.component.html
│   │   │   ├── edit-camp.component.spec.ts
│   │   │   └── edit-camp.component.ts
│   │   ├── layouts
│   │   │   └── admin-layout
...
│   │   │   ├── view-client-request.component.spec.ts
│   │   │   └── view-client-request.component.ts
│   │   ├── typography
│   │   │   ├── typography.component.css
│   │   │   ├── typography.component.html
│   │   │   ├── add-camp.component.spec.ts
│   │   │   └── add-camp.component.ts
│   │   ├── upgrade
